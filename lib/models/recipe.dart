...
class Recipe {
  ...
  Recipe.fromMap(Map<String, dynamic> data, String id, User _authenticatedUser,SharedPreferences fav )
      : this(
          id:id,
      ...
      //    isFavourite:(data['wishlistuser']['arrayValue'] as Map<String, dynamic>).containsKey(_authenticatedUser.id),
          isFavourite:fav.getStringList(_authenticatedUser.id)==null?false:fav.getStringList(_authenticatedUser.id).contains(data['title']['stringValue']),
